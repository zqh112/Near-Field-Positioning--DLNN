...
```plaintext
@ARTICLE{11222702,
  author={Zhu, Qihao and Wang, Yu and Ohtsuki, Tomoaki and Mao, Shiwen and Niyato, Dusit and Gui, Guan},
  journal={IEEE Wireless Communications Letters}, 
  title={Bio-Inspired Dendritic Liquid Neural Network for Robust Near-Field Positioning in B5G/6G}, 
  year={2025},
  volume={},
  number={},
  pages={1-1},
  keywords={Liquids;Adaptation models;Computational modeling;Vectors;Computer architecture;Spatiotemporal phenomena;Training;Robustness;Noise;Meters;Deep learning;near-field;target localization;liquid neural network},
  doi={10.1109/LWC.2025.3627310}}
```
